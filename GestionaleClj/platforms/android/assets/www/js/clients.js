...
function populateList(filter){
	...
	$.ajax({
      dataType: "json",
      url: "http://gestionaleclj.com/script_php/getClients.php?q="+ q+"&db="+getCookie('nomeDB'), //Relative or absolute path to response.php file
      data:"",
...
function deleteCliente(){
	...
	$.ajax({
		url: "http://gestionaleclj.com/script_php/deleteClient.php", //Relative or absolute path to response.php file
	      type:"POST",	
...
function modifyCliente(){
	...
	$.ajax({
	     url: "http://gestionaleclj.com/script_php/updateClients.php", //Relative or absolute path to response.php file
	      type:"POST",
	      async:false,
	      data:{
