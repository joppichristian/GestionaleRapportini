...
function deleteMezzo(){
					...
					$.ajax({
				      url: "http://gestionaleclj.com/script_php/deleteMezzi.php", //Relative or absolute path to response.php file
				      type:"POST",
...
function modifyMezzo(){
	...
	$.ajax({
	     url: "http://gestionaleclj.com/script_php/updateMezzi.php", //Relative or absolute path to response.php file
	      type:"POST",
	      async:false,
	      data:{
