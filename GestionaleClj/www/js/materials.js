...
function deleteMateriale(){
					...
					$.ajax({
				      url: "http://gestionaleclj.com/script_php/deleteMaterial.php", //Relative or absolute path to response.php file
				      type:"POST",
...
function modifyMateriale(){
	...
	$.ajax({
	     url: "http://gestionaleclj.com/script_php/updateMaterials.php", //Relative or absolute path to response.php file
	      type:"POST",
	      async:false,
	      data:{
		      'codice':codice,
