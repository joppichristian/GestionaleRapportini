...
function populateListClient(filter){
	$.ajax({
      dataType: "json",
      url: "http://gestionaleclj.com/script_php/getClients.php?q="+filter+"&db="+getCookie('nomeDB'), //Relative or absolute path to response.php file
      data:"",
...
function populateListMaterials(filter){
	$.ajax({
      dataType: "json",
      url: "http://gestionaleclj.com/script_php/getMaterials.php?q="+ filter+"&db="+getCookie('nomeDB'), //Relative or absolute path to response.php file
      data:"",
      success: function(data) {
	    json_materiali = data;
        var elementi = new Array();
...
function populateListMezzi(filter){
	$.ajax({
      dataType: "json",
      url: "http://gestionaleclj.com/script_php/getMezzi.php?q="+ filter+"&db="+getCookie('nomeDB'), //Relative or absolute path to response.php file
      data:"",
      success: function(data) {
	    json_mezzi = data;
        var elementi = new Array();
...
function aggiungiRapportino(){
	$.ajax({
      type:"POST",
      url: "http://gestionaleclj.com/script_php/postRapportinoRapido.php", //Relative or absolute path to response.php file
      async:false,
      data:{
...
function addCliente(){
	if($("#nominativo").val() == ""){
		...
		$.ajax({
	      url: "http://gestionaleclj.com/script_php/postClients.php", //Relative or absolute path to response.php file
	      type:"POST",
	      async:false,
	      data:{
		   ...
		   success: function(data){		   
		   		...
		   		$.ajax({
			      dataType: "json",
			      url: "http://gestionaleclj.com/script_php/getClients.php?q="+nominativo+"&db="+getCookie('nomeDB'), //Relative or absolute path to response.php file
			      data:"",
			      success: function(data) {
